...
def TextFieldOptionsAddIsLocalized(builder, isLocalized): builder.PrependBoolSlot(5, isLocalized, 0)
def TextFieldOptionsAddPlaceHolder(builder, placeHolder): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(placeHolder), 0)
def TextFieldOptionsAddPasswordEnabled(builder, passwordEnabled): builder.PrependBoolSlot(7, passwordEnabled, 0)
def TextFieldOptionsAddPasswordStyleText(builder, passwordStyleText): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(passwordStyleText), 0)
def TextFieldOptionsAddMaxLengthEnabled(builder, maxLengthEnabled): builder.PrependBoolSlot(9, maxLengthEnabled, 0)
def TextFieldOptionsAddMaxLength(builder, maxLength): builder.PrependInt32Slot(10, maxLength, 0)
def TextFieldOptionsAddAreaWidth(builder, areaWidth): builder.PrependInt32Slot(11, areaWidth, 0)
def TextFieldOptionsAddAreaHeight(builder, areaHeight): builder.PrependInt32Slot(12, areaHeight, 0)
def TextFieldOptionsAddIsCustomSize(builder, isCustomSize): builder.PrependBoolSlot(13, isCustomSize, 0)
